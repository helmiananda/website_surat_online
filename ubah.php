    ...
    <div class="wrapper">
        ...
        <form action="" method="post">
            ...
            <ul>
                ...
                <input type="radio" class="radio" name="jk" value="Laki-laki" id="jk" required value="<?= $input_data_surat ["jk"]; ?>"> Laki-laki
                <input type="radio" class="radio" name="jk" value="Perempuan"  id="jk" required value="<?= $input_data_surat ["jk"]; ?>"> Perempuan
                </li> <br>
                <li>
                ...
                <label for="jenis_surat">Jenis Surat</label>
                    <input type="text" class="input" name="jenis_surat"  id="jenis_surat" required value="<?= $input_data_surat ["jenis_surat"]; ?>">
                </li> <br>
                <li>
